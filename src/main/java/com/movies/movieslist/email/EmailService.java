...
public class EmailService {
    ...
    private static String LINK="http://localhost:5500/index.html?token=";//"http://localhost:8888/api/v1/registration/confirm?token=";
    ...
    private String buildEmailConfirmAccount(String link){
        ...
        return "<!DOCTYPE html>\n" +
                ...
                "              <h1 style=\"margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;\">My Movies List</h1>\n" +
                "            </td>\n" +
                "          </tr>\n" +
                "        </table>\n" +
                "        <!--[if (gte mso 9)|(IE)]>\n" +
